...
function XMLPreviewBox() {
    ...
    const { imageFiles, imageSizes, shapes, selPreviewIndex, xmlPreviewBoxVisible } = state;

    const onOk = () => {
        const xml = generateXML(imageFiles[selPreviewIndex], imageSizes[selPreviewIndex], shapes[selPreviewIndex]);
